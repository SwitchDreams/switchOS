...
func TestRoundRobinFinal(t *testing.T) {
	processes := []p.Process{
		{ID: 1, ArrivalTime: 0, Duration: 7},
		{ID: 2, ArrivalTime: 2, Duration: 4},
		{ID: 3, ArrivalTime: 4, Duration: 1},
		{ID: 4, ArrivalTime: 5, Duration: 4},
	}
